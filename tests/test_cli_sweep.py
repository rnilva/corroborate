...
Exercises substrate resolution + `--dry-run` against the in-tree
...
# ============ Substrate `SWEEP_ENTRY_POINTS` shape sanity ============
...
def test_in_tree_substrate_exposes_entry_points() -> None:
    ...
    # All five callables present (substrate provides full surface).
...
def test_sweep_run_dry_run(
    ...
    in-tree substrate, expands templates, and prints the summary
...
def test_sweep_run_missing_substrate_module(
    ...
    """A substrate name that doesn't import raises SystemExit
