...
BLOCKED_ON: str | None = (
    ...
    'per env — qualifying envs are Acrobot, CartPole, '
    'MountainCar, LunarLander (MLP-state with bucket_hash) and '
    '4 MinAtar (image_downsample_hash). After backfill of '
    'γ=0.999 corpora for those envs into ddqn_sweeps with '
    'transitive_reads catching the new bridges, Edge 1/2/3 '
    'will fire. Preliminary canonical-ddqn-cache estimate at '
    'γ=0.99: Asterix H_cond_VAN=1.39 vs H_cond_DDQN=1.38 (≈0 '
    'diff); SI d_H_marg=-0.57 (DDQN LOWER, contradicts the '
    'mechanism prediction direction). γ=0.999 TBD — mechanism '
    'predicts DDQN > VAN amplified by 1/(1−γ); if it stays '
    'NEGATIVE at γ=0.999, the chain refutes and the harm '
    'mechanism story needs revision.'
)
