...
estimate of the within-stratum treatment-effect Δ. Compare to the
seed-paired sibling `paired_delta_link_dowhy`, which builds rows
per-(env, burst, seed) — pseudo-replicating each stratum by N
...
Output shape mirrors `PairedDeltaLinkDowhyResult` but renames
`n_pairs` → `n_strata` to be honest about the unit of inference."""
