...
def main() -> None:
    ...
    caveats = (
        ...
        '      visitation changes outcome. Bias contains Q, so it\n'
        '      predicts outcome via this longer pathway.\n\n'
        ...
        'Next falsification step: state-visitation siblings\n'
        '(state_hash_n_unique/entropy/repeat_rate). If they\n'
        'also d-separate at Asterix, non-Q channels are\n'
        'parallel; if not, Q-channel is special.'
    )
