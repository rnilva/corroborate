...
def main() -> None:
    ...
    caveats = (
        ...
        'Multi-input sibling test (v7) — sibling-set-sensitive:\n'
        '  vs 4 Q-shape only: n_01=7/n_10=0, GENUINE (Bonf-5)\n'
        '  vs 6 (Q-shape + policy-shape argmax_ent + entSC):\n'
        '     n_01=4/n_10=0, UPFG — exact p=0.0625 > α=0.05.\n'
        'Adding policy-shape mediators absorbs 12pp of arm→\n'
        'outcome signal Q-shape alone misses; bias survives MC\n'
        'and state-vis adjudications but does NOT cleanly\n'
        'survive the 6-Q-derived joint sibling set.\n'
        'Bias is part of a Q-derived cluster, not uniquely\n'
        'pivotal. Lesson: read GENUINE conservatively at small\n'
        'sibling sets; verdicts can only walk back as sibling\n'
        'set grows.'
    )
